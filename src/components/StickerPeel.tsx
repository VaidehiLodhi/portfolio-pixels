...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  return (
    <div className={`relative transform-gpu ${className}`} style={cssVars}>
      <style
      ...
      >
        ...
        <div
          className="absolute top-4 left-2 w-full h-full opacity-20"
          style={{ filter: "brightness(0) blur(20px)" }}
        >
