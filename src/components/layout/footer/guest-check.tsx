...
export const GuestCheck = () => {
  return (
    <div className="flex flex-col bg-[#F5E1CD] pb-4 rounded-[10px] text-[#2B0C7D] max-w-75">
      <p className={`${imfell.className} text-center text-[30px]`}>
        Guest Check
      </p>
      <div
        className={`${futura_book.className} flex px-6 py-1 text-[10px] items-stretch justify-center`}
      >
        {["Date", "Table", "Guests", "Server"].map((item) => (
          <div
            key={item}
            className="border border-r-0 border-[#2B0C7D] px-2 h-8 flex items-start justify-center"
          >
            {item}
          </div>
        ))}
        ...
        <div
          className={`${courier_prime.className} text-[#DF4346] text-lg border border-[#2B0C7D] px-2 h-8 flex items-center justify-center`}
        >
          143007
        </div>
      </div>
      ...
      <div
        className={`${futura_book.className} flex items-center justify-around gap-x-1 text-[8px] px-10`}
      >
        {[
          "APT",
          ".",
      ...
      <div className="flex items-center justify-center px-4">
        ...
        <div className="w-37.5 h-7 border border-[#2B0C7D] border-l-0" />
        <div className="w-8 h-7 border border-[#2B0C7D] border-l-0" />
      ...
      {[...Array(8)].map((_, i) => (
        <div key={i} className="flex items-center justify-center px-4">
          ...
          <div className="w-37.5 h-7 border border-[#2B0C7D] border-l-0 border-t-0" />
          <div className="w-8 h-7 border border-[#2B0C7D] border-l-0 border-t-0" />
